...
// Music Array
let musicNames = ['mortal', 'kosandra', 'Saw Music', 'warsong', 'legends never die', 'he kahan ka irada']
...
function loadSong(i) {
  ...
  record.src = `Thumbnail/${musicNames[i]}.jpg`
  blurredBg.src = `Thumbnail/${musicNames[i]}.jpg`
  addingRemovingEvent();
  setTitle(i)
